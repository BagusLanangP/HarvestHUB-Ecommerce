...
@section('tittle', 'Detail Tenaga Kerja')
...
<section class="service-detail-section py-5">
    <div class="container py-4">
        {{-- Back Button --}}
        <div class="mb-4">
            <a href="/Tenagakerja/view" class="btn btn-link text-success p-0 fw-semibold text-decoration-none d-inline-flex align-items-center gap-1">
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-4">
                <div class="card border-0 shadow rounded-4 p-4 text-center bg-white profile-card-left">
                    ...
                    <span class="badge bg-success-subtle text-success border border-success-subtle px-3 py-1.5 fw-semibold rounded-pill mb-3" style="font-size: 0.8rem;">
                        <i class="bi bi-person-workspace me-1"></i> {{ $itemproduk->keahlian }}
                    </span>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        @endphp
                        <a href="https://wa.me/{{ $waPhone }}?text=Halo%20{{ urlencode($itemproduk->nama) }},%20saya%20tertarik%20dengan%20jasa%20pekerjaan%20Anda%20di%20HarvestHUB." 
                           target="_blank" 
            ...
            <div class="col-12 col-lg-8">
                <div class="card border-0 shadow rounded-4 p-4 bg-white profile-card-right h-100">
                    {{-- Judul Sekilas --}}
                    <div class="mb-4">
                        <span class="text-secondary text-uppercase fw-bold ls-2" style="font-size: 0.75rem;">Profil Jasa Tenaga Kerja</span>
                        <h2 class="fw-bold text-dark mt-1">Rincian Kualifikasi & Deskripsi Kerja</h2>
                    ...
                    <div class="mb-4">
                        <h5 class="fw-bold text-dark d-flex align-items-center gap-2 mb-3">
                            <i class="bi bi-person-lines-fill text-success"></i> Tentang Tenaga Kerja
                        </h5>
                    ...
                    <div>
                        <h5 class="fw-bold text-dark d-flex align-items-center gap-2 mb-3">
                            <i class="bi bi-briefcase text-success"></i> Pengalaman Kerja & Keahlian Tani
                        </h5>
                        <div class="text-secondary leading-relaxed p-3 bg-light rounded-3 border" style="font-size: 0.95rem;">
